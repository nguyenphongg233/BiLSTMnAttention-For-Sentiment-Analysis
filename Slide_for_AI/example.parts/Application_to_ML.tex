\begin{frame}[t]{\textbf{\large 4. Ứng dụng trong Học máy (Machine Learning)}}\vspace*{-1cm}	\begin{block}{Mục tiêu nghiên cứu}
...
\begin{frame}[t]{\textbf{\large Cơ sở lý thuyết và Phương pháp tiếp cận}}\vspace*{-0.5cm}	\begin{itemize}
...
\begin{frame}[t]{\textbf{\large 4.2.1 Lựa chọn đặc trưng có giám sát: Thiết lập}}\vspace*{-1cm}	\textbf{Đầu vào:}
	\begin{itemize}
...
\begin{frame}[t]{\textbf{\large 4.3.1 Hồi quy Logistic đa biến: Thiết lập}}\vspace*{-1cm}	\textbf{Bài toán:}
	\begin{itemize}
...
\begin{frame}[t]{\textbf{\large 4.3.2 Kết quả Hồi quy Logistic}}
    ...
    $\bullet$ GDA vượt trội hơn GD và Nesterov về giá trị hàm mục tiêu.
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            \centering
            \includegraphics[width=\linewidth]{res/Figure_5_2_mush_compare.png}
        \end{column}
        \begin{column}{0.5\textwidth}
            \centering
            \includegraphics[width=\linewidth]{res/Figure_5_2_w8a_compare.png}
        \end{column}
    \end{columns}
...
\begin{frame}{\textbf{\large 4.3.3 Kết quả Hồi quy Logistic}}
    $\bullet$ \textbf{Hình 5} minh họa cơ chế tự thích nghi: Bước nhảy giảm dần từ giá trị ban đầu (với hệ số $\kappa = 0.75$)
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            \centering
        ...
        \end{column}
    \end{columns} % Tạo khoảng cách giữa ảnh và chú thích
...
\begin{frame}{\textbf{\large 4.3.3 Kết quả Hồi quy Logistic (tiếp theo)}}
    $\bullet$ \textbf{Hình 6} trình bày sự giảm kích thước bước nhảy từ một kích thước bước nhảy ban đầu liên quan đến các kết quả trong Hình 5.
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            \centering
...
\begin{frame}[t]{\textbf{\large 4.4.1 Mạng Nơ-ron cho phân loại ảnh}}\vspace*{-0.5cm}	\textbf{Mục tiêu:}
...
\begin{frame}[t]{\textbf{\large 4.4.2 Kết quả huấn luyện Mạng Nơ-ron}}\vspace*{-1cm}	\textbf{Kết quả (Hình 7 \& 8):}
